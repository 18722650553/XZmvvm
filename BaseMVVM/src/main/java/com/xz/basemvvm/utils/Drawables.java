 ...
 * @ClassName: Drawables
 * @Author: 于学智
 * @Description: 使用DataBinding时可以使用该库 https://github.com/whataa/noDrawable
    ...
    public static void setViewBackground(
        ...
        if (count < 1) {
            ...
            if (count == 1 && !isDefaultNull) {
                ...
                com.xz.basemvvm.utils.ProxyDrawable listDrawable = new com.xz.basemvvm.utils.ProxyDrawable();
                if (checkedDrawable != null) {
                ...
                if (defaultDrawable != null) {
                    ...
                    if (originDrawable != null) {
                        if (originDrawable instanceof com.xz.basemvvm.utils.ProxyDrawable) {
                            originDrawable = ((com.xz.basemvvm.utils.ProxyDrawable) originDrawable).getOriginDrawable();
                        }
